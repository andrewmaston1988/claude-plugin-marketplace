...
substance only — no filler sections or boilerplate summaries. Correct earlier
statements only when it changes the reader's decisions; otherwise fix silently.
Deliver the asked scope; flag better approaches in one sentence, then proceed.
