...
9. **Once the run's work has landed, `prune <resultsDir>`** destroys its kept worktrees and their branches — the operator's call, never the leaf's and never automatic.
