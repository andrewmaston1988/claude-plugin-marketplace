...
import { readFileSync, writeFileSync, renameSync, unlinkSync, existsSync, mkdirSync, copyFileSync, openSync } from "node:fs";
...
export function spawnLoggedDaemon(argv, home, { _spawn = spawn, _openSync = openSync } = {}) {
  mkdirSync(home, { recursive: true });
