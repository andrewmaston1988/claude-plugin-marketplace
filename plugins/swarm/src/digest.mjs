...
// model. The read-only digest reads the dispatching repo in place, like any other
// reader; the report digest can write, so it sits in its own scratch dir and reads
// leaf results through the absolute paths its prompt names.
