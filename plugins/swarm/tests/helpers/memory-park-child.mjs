...
const a = { id: "a", prompt: "do a", provider: "claude", model: "claude-haiku-4-5-20251001", allowedTools: "Read", cwd: dir, originalCwd: dir, timeoutMs: 5000, after: [] };
const b = { id: "b", prompt: "do b", provider: "claude", model: "claude-haiku-4-5-20251001", allowedTools: "Read", cwd: dir, originalCwd: dir, timeoutMs: 5000, after: [] };
