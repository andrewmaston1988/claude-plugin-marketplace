// Verbatim fork of plugins/claude-peers/src/mcp/jsonrpc.mjs. Newline-delimited
// JSON-RPC 2.0 over a pair of streams — the framing Claude Code's stdio MCP
// transport speaks. stdout must carry protocol lines only.
